...
Без INT8: `15.564 ms/img`, с INT8: `11.4964 ms/img`. Сборка движка с калибровкой занимает больше времени, однако это выполняется единственный раз для данной версии Cuda/драйверов и архитектуры видеокарты. Ускорение практически на 30% на достаточно маленькой модели. Чем больше модель, тем значительнее разница.
